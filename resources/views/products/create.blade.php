                        ...
                        <template x-for="(row, index) in rows" :key="index">
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-gray-50/50 border border-gray-200/40 p-4 rounded-xl">
                                ...
                                <div class="flex-1 w-full">
                                    ...
                                    {{-- Validation Helper --}}
                                    <template x-if="$errors && $errors.has('ingredients.'+index+'.ingredient_id')">
                                        <p class="mt-1 text-xs text-red-500 font-medium" x-text="$errors.first('ingredients.'+index+'.ingredient_id')"></p>
                                    </template>
                                </div>
