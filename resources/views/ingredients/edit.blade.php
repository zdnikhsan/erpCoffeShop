<x-app-layout>
    ...
    <div class="py-6">
        <div class="bg-white border border-gray-200/60 overflow-hidden shadow-sm rounded-2xl">
            <form method="POST" action="{{ route('ingredients.update', $ingredient) }}" class="p-6 sm:p-8 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="stock" name="stock" value="{{ old('stock', $ingredient->stock) }}" min="0" step="0.01"
                               placeholder="0.00"
                ...
                <div>
                    ...
                    <input type="number" id="safety_stock" name="safety_stock" value="{{ old('safety_stock', $ingredient->safety_stock) }}" min="0" step="0.01"
                           placeholder="0.00"
